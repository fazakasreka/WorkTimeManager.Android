...
const val defaultEndHour= 18
const val defaultEndMinute = 0
const val clockFormat = "%02d:%02d"
const val dateFormat = "yyyy.MM.dd"
const val noConnectionErrorMessage = "You don't seem to be connected to the internet."